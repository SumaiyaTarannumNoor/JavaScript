...
//     console.log(name + " Sasuke");
// }
// greet('Sasuke') //Sasuke is an argument to the greet function
// greet('Sasuke Uchiha')

//This function is performing a task
// function greet(name , lastName){
//     console.log("Sasuke " + name + " " +lastName);
// }
// greet('Sasuke', 'Itachi')
